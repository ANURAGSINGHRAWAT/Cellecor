...
export default function Profile({data , setData}) {
    ...
    //     let tempPinfoIndex = data.findIndex((el) => el.id == infoId);
    //     let tempdata = [...data];

    //     tempdata[tempPinfoIndex].fname = fname;
    //     tempdata[tempPinfoIndex].lname = lname;
    //     tempdata[tempPinfoIndex].email = email;
    //     tempdata[tempPinfoIndex].gender = gender;
    //     tempdata[tempPinfoIndex].num = num;
    //     setData(tempdata)
    ...
    const handleSubmit = () => {
        ...
        if (fname == "") {
          ...
          if (isEdit) {
            ...
            tempdataArr[0].fname = fname;
            tempdataArr[0].lname = lname;
            tempdataArr[0].email = email;
            tempdataArr[0].gender = gender;
            tempdataArr[0].num = num;
          }else {

            let newdataobj = {};
            newdataobj.fname = fname;
            newdataobj.num = num;
            newdataobj.lname = lname;
            ...
            <div className={style.profile_form}>
                <div className={style.persnol_info}>
                    ...
                    <div className={style.edit_link}>
                        <button className={`${style.edit} btn`}  onClick={()=>handelAddressEdit(data[0])}>Edit</button>
